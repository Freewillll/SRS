...
from modules import Upsample, ConvDropoutNormNonlin, InitWeights_He, StackedConvLayers
...
if __name__ == '__main__':
    ...
    input = torch.randn(1, configs['in_channels'], 32,64,64)
    model = UNet(**configs)
    print(model)
    ...
    summary(model, input_size=(1,1,32,64,64))